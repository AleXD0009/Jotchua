...
const handler = async (m, {text, conn, args, usedPrefix, command}) => {
  ...
  const { key } = await conn.sendMessage(m.chat, {text: `*_se esta procesando su audio🐶_*\n\n*si su audio no es enviado pruebe con el comando #playdoc ᴏ #play.2 ᴏ #ytmp4doc*`}, {quoted: m});
  try {
